...
public class UserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		MongoClientURI uri = new MongoClientURI("mongodb://UdayKiran:UdayKiran@ds161495.mlab.com:61495/udaykiran");
		MongoClient client = new MongoClient(uri);

		DB db = client.getDB(uri.getDatabase());
		DBCollection users = db.getCollection("tut10");
		BasicDBObject query = new BasicDBObject();
		query.put("name","UdayKiran");// request.getParameter("name"));
		query.put("password","UdayKiran"); //request.getParameter("password"));
